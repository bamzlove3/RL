...
function AlertNonSteamSite( elem )
{
	...
	if ( hostname )
	{
		...
		return confirm( 'Megjegyzés: az URL, melyre kattintottál, nem hivatalos Steam weboldal.\n\n'
						+ url.replace( new RegExp( '^steam://openurl(_external)?/' ), '' ) + '\n\n'
						+ 'Ha ez a weboldal felhasználóneved vagy jelszavad kéri, ne add meg! Elveszítheted Steam fiókod és minden játékod!\n'
	...
	BindSubscribeButtons: function( elBtnSubscribe, elBtnUnsubscribe )
	{
		...
		$J(elBtnUnsubscribe).click( function() {
			_this.Unsubscribe( function() {
				ShowAlertDialog('Leiratkozás a témáról', 'A továbbiakban nem kapsz megjegyzés-értesítéseket erről a témáról.');
			}, function() {
