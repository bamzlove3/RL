...
function checkAbuseSub( elForm )
{
	...
	$J.post( 'https://steamcommunity.com/actions/ReportAbuse/', params).done( function() {
		ShowAlertDialog( 'Merci !', 'Nous vous remercions d\'avoir signalé du contenu choquant. Grâce à vous, nous allons pouvoir préserver le caractère convivial et civilisé de la communauté Steam.' );
	}).fail( function() {
...
function AlertNonSteamSite( elem )
{
	...
	if ( hostname )
	{
		...
		return confirm( 'Note : le lien sur lequel vous venez de cliquer ne correspond pas à un site internet officiel Steam.\n\n'
						...
						+ 'Si ce site internet vous demande votre nom d\'utilisateur ou votre mot de passe, ne saisissez surtout pas ces informations : vous pourriez perdre votre compte Steam et vos jeux !\n'
...
function ChangeLanguage( strTargetLanguage, bStayOnPage )
{
	...
	$J.post( 'https://steamcommunity.com/actions/SetLanguage/', {language: strTargetLanguage, sessionid: g_sessionID })
		.done( function() {
			...
			Modal.Dismiss();
			ShowAlertDialog( 'Changer la langue', 'Un problème de communication avec les serveurs Steam a été rencontré. Veuillez réessayer plus tard.' );
		});
}
