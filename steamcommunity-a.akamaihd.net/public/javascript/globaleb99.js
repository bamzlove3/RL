...
function checkAbuseSub( elForm )
{
	...
	$J.post( 'https://steamcommunity.com/actions/ReportAbuse/', params).done( function() {
		ShowAlertDialog( 'ขอบคุณ!', 'ขอบคุณสำหรับการรายงานเนื้อหาที่ไม่เหมาะสมและความช่วยเหลือในการดูแลชุมชน Steam ให้สะอาดและเป็นมิตร' );
	}).fail( function() {
		ShowAlertDialog( 'รายงานการละเมิด', 'ตรวจพบปัญหาในการบันทึกรายงานของคุณ กรุณาลองใหม่ภายหลัง' );
	});
	return false;
}
...
function ChangeLanguage( strTargetLanguage, bStayOnPage )
{
	...
	$J.post( 'https://steamcommunity.com/actions/SetLanguage/', {language: strTargetLanguage, sessionid: g_sessionID })
		.done( function() {
			...
			Modal.Dismiss();
			ShowAlertDialog( 'เปลี่ยนภาษา', 'ตรวจพบปัญหาในการติดต่อสื่อสารกับเซิร์ฟเวอร์ Steam กรุณาลองใหม่ภายหลัง' );
		});
}
...
var CCommentThread = Class.create( {
	...
	initialize: function( type, name, rgCommentData, url, nQuoteBoxHeight )
	{
		...
		this.m_$SubscribeCheckbox.click( function() {
			...
			if ( _this.m_bSubscribed )
				_this.Unsubscribe( function() {},  function() {ShowAlertDialog('สมัครสมาชิกความเห็นนี้', 'ตรวจพบปัญหาในการอัปเดตการสมัครสมาชิกของคุณ กรุณาลองใหม่ภายหลัง');});
			else
				_this.Subscribe( function() {},  function() {ShowAlertDialog('สมัครสมาชิกความเห็นนี้', 'ตรวจพบปัญหาในการอัปเดตการสมัครสมาชิกของคุณ กรุณาลองใหม่ภายหลัง');});
		});
	...
	DisplayError: function( elError, transport )
	{
		...
		if ( transport.responseJSON && transport.responseJSON.error )
			...
			strMessage += 'ตรวจพบข้อผิดพลาดในการติดต่อสื่อสารกับเครือข่าย กรุณาลองใหม่ภายหลัง';
	...
	BindSubscribeButtons: function( elBtnSubscribe, elBtnUnsubscribe )
	{
		...
		$J(elBtnSubscribe).click( function() {
			_this.Subscribe( function() {
				...
				ShowAlertDialog('สมัครสมาชิกความเห็นนี้', 'ตรวจพบปัญหาในการอัปเดตการสมัครสมาชิกของคุณ กรุณาลองใหม่ภายหลัง');
			});
		});
		...
		$J(elBtnUnsubscribe).click( function() {
			_this.Unsubscribe( function() {
				...
				ShowAlertDialog('ยกเลิกการสมัครสมาชิกความเห็นนี้', 'ตรวจพบปัญหาในการอัปเดตการสมัครสมาชิกของคุณ กรุณาลองใหม่ภายหลัง');
			});
		});
...
function ShareContentToUserStatus( text, urlToShare, appID, posturl )
{
	...
	new Ajax.Request( posturl, {
		...
		onFailure: function(transport) {
			ShowAlertDialog( 'แบ่งปัน', 'ตรวจพบปัญหาในการแบ่งปันการอัปเดตสถานะของคุณ กรุณาลองใหม่ภายหลัง' );
		}
	});
}
