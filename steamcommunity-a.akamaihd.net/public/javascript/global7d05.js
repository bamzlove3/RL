...
function checkAbuseSub( elForm )
{
	...
	$J.post( 'https://steamcommunity.com/actions/ReportAbuse/', params).done( function() {
		ShowAlertDialog( 'Дякуємо!', 'Дякуємо, що повідомили про образливий зміст та допомогли нам зберегти спільноту Steam чистою та дружньою.' );
	}).fail( function() {
...
function AlertNonSteamSite( elem )
{
	...
	if ( hostname )
	{
		...
		return confirm( 'Примітка: адреса, на яку ви натиснули не є офіційним сайтом Steam.\n\n'
						...
						+ 'Якщо цей веб-сайт спитає ваш логін або пароль, не вводьте ці дані. Ви можете втратити ваш акаунт Steam та всі ваші ігри!\n'
...
function ChangeLanguage( strTargetLanguage, bStayOnPage )
{
	...
	$J.post( 'https://steamcommunity.com/actions/SetLanguage/', {language: strTargetLanguage, sessionid: g_sessionID })
		.done( function() {
			...
			Modal.Dismiss();
			ShowAlertDialog( 'Змінити мову', 'Виникла проблема під час сполучення із серверами Steam. Будь ласка, спробуйте знову пізніше.' );
		});
}
