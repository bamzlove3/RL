...
function checkAbuseSub( elForm )
{
	...
	$J.post( 'https://steamcommunity.com/actions/ReportAbuse/', params).done( function() {
		ShowAlertDialog( 'Teşekkür Ederiz!', 'Saldırgan içeriği şikayet ettiğiniz ve Steam Topluluğunun temiz ve arkadaşça kalmasına yardım ettiğiniz için teşekkür ederiz.' );
	}).fail( function() {
...
function ChangeLanguage( strTargetLanguage, bStayOnPage )
{
	...
	$J.post( 'https://steamcommunity.com/actions/SetLanguage/', {language: strTargetLanguage, sessionid: g_sessionID })
		.done( function() {
			...
			Modal.Dismiss();
			ShowAlertDialog( 'Dili değiştir', 'Steam sunucularıyla iletişim kurulurken bir sorun meydana geldi. Lütfen daha sonra tekrar deneyiniz.' );
		});
}
...
var CCommentThread = Class.create( {
	...
	{
		var strMessage = 'Affedersiniz, bir tür hata meydana geldi: ';
