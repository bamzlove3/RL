...
function checkAbuseSub( elForm )
{
	...
	$J.post( 'https://steamcommunity.com/actions/ReportAbuse/', params).done( function() {
		ShowAlertDialog( 'Tack!', 'Tack för att du anmälde stötande innehåll och hjälper oss att hålla en fin och vänlig stämning på Steams gemenskap.' );
	}).fail( function() {
	...
	initialize: function( type, name, rgCommentData, url, nQuoteBoxHeight )
	{
		...
		this.m_$SubscribeCheckbox.click( function() {
			...
			if ( _this.m_bSubscribed )
				_this.Unsubscribe( function() {},  function() {ShowAlertDialog('Abonnera på tråd', 'Det uppstod ett problem vid uppdatering av abonnemang. Försök igen senare.');});
			else
				_this.Subscribe( function() {},  function() {ShowAlertDialog('Abonnera på tråd', 'Det uppstod ett problem vid uppdatering av abonnemang. Försök igen senare.');});
		});
	...
	BindSubscribeButtons: function( elBtnSubscribe, elBtnUnsubscribe )
	{
		...
		$J(elBtnSubscribe).click( function() {
			_this.Subscribe( function() {
				ShowAlertDialog('Abonnera på tråd', 'Du kommer att få ett kommentarsmeddelande när någon svarar på denna tråd.');
			}, function() {
				ShowAlertDialog('Abonnera på tråd', 'Det uppstod ett problem vid uppdatering av abonnemang. Försök igen senare.');
			});
		});

		$J(elBtnUnsubscribe).click( function() {
			_this.Unsubscribe( function() {
				ShowAlertDialog('Sluta abonnera på tråd', 'Du kommer inte längre få kommentarsmeddelanden från denna tråd.');
			}, function() {
				ShowAlertDialog('Sluta abonnera på tråd', 'Det uppstod ett problem vid uppdatering av abonnemang. Försök igen senare.');
			});
		});
