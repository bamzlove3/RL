...
function checkAbuseSub( elForm )
{
	...
	$J.post( 'https://steamcommunity.com/actions/ReportAbuse/', params).done( function() {
		ShowAlertDialog( 'Kiitos!', 'Kiitos, että ilmoitit loukkaavasta sisällöstä ja autat pitämään Steam-yhteisön siistinä ja ystävällisenä.' );
	}).fail( function() {
...
function AlertNonSteamSite( elem )
{
	...
	if ( hostname )
	{
		...
		return confirm( 'Huomautus: URL-osoite, jota klikkasit, ei sijaitse Steamin virallisella verkkosivulla.\n\n'
