		...
		$SelectBox.append(
			$J('<option/>', {value: "romanian"} ).text( 'Română (Romanian)' )
				...
				$J('<option/>', {value: "danish"} ).text( 'Dansk (Daneză)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "dutch"} ).text( 'Nederlands (Olandeză)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "english"} ).text( 'Engleză' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "polish"} ).text( 'Polski (Poloneză)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "portuguese"} ).text( 'Português (Portugheză)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "schinese"} ).text( '简体中文 (Chineză Simplificată)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "spanish"} ).text( 'Español (Spaniolă)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "swedish"} ).text( 'Svenska (Suedeză)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "tchinese"} ).text( '繁體中文 (Chineză Tradiţională)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "thai"} ).text( 'ไทย (Tailandeză)' )
			);
					$SelectBox.append(
