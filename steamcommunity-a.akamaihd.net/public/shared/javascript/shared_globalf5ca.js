	...
	.fail( function( jqxhr ) {
		...
		switch ( responseJSON.success )
		{
			...
			case 24:
				...
				break;
			case 15:
				ShowAlertDialog( 'ข้อผิดพลาด', 'คุณไม่ได้รับอนุญาตให้ดำเนินการดังกล่าว' );
				break;
			default:
				ShowAlertDialog( 'ข้อผิดพลาด', 'ตรวจพบข้อผิดพลาดขณะกำลังประมวลผลคำร้องของคุณ:' + responseJSON.success );
				break;
		}
	} );
	return false;
