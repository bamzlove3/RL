		...
		switch ( responseJSON.success )
		{
			...
			case 24:
				ShowAlertDialog( 'Erro',
					'A tua conta não cumpre os requisitos necessários para a utilização desta funcionalidade. <a class="whiteLink" href="https://help.steampowered.com/pt/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Visita o Suporte Steam</a> para mais informações.'
				);
				break;
			case 15:
