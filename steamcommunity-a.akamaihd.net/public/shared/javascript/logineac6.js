...
CLoginPromptManager.prototype.DoLogin = function()
{
	...
	$J.post( this.m_strBaseURL + 'getrsakey/', this.GetParameters( { username: username } ) )
		...
		.fail( function () {
			ShowAlertDialog( 'Hata', 'Steam sunucularıyla iletişim kurulurken bir sorun meydana geldi. Lütfen daha sonra tekrar deneyiniz.' );
