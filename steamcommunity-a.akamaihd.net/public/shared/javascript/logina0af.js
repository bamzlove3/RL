...
CLoginPromptManager.prototype.DoLogin = function()
{
	...
	$J.post( this.m_strBaseURL + 'getrsakey/', this.GetParameters( { username: username } ) )
		...
		.fail( function () {
			ShowAlertDialog( 'Feil', 'Et problem oppstod under kommunikasjon med Steams tjenere. Prøv igjen senere.' );
...
CLoginPromptManager.prototype.StartTwoFactorAuthProcess = function()
{
	...
	var _this = this;
	this.m_TwoFactorModal = ShowDialog( 'Mobil tofaktorautentisering med Steam Guard', this.m_$ModalTwoFactor.show() )
