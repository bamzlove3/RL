		...
		$SelectBox.append(
			$J('<option/>', {value: "norwegian"} ).text( 'Norsk' )
				...
				$J('<option/>', {value: "polish"} ).text( 'Polski (polsk)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "portuguese"} ).text( 'Português (portugisisk)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "brazilian"} ).text( 'Português-Brasil (brasiliansk-portugisisk)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "schinese"} ).text( '简体中文 (forenklet kinesisk)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "spanish"} ).text( 'Español (spansk)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "tchinese"} ).text( '繁體中文 (tradisjonell kinesisk)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "thai"} ).text( 'ไทย (thailandsk)' )
			);
					$SelectBox.append(
