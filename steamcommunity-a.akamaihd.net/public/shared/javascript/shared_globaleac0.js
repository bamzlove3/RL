		...
		switch ( responseJSON.success )
		{
			...
			case 24:
				ShowAlertDialog( 'Błąd',
					'Twoje konto nie spełnia wymagań niezbędnych do korzystania z tej funkcji. <a class="whiteLink" href="https://help.steampowered.com/pl/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Odwiedź stronę Pomocy technicznej Steam</a> po więcej informacji.'
				);
				break;
			case 15:
				ShowAlertDialog( 'Błąd', 'Nie posiadasz uprawnień, aby wykonać tę czynność.' );
				break;
			default:
