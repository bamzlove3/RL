...
function RateAnnouncement( rateURL, gid, bVoteUp )
{
	...
	.fail( function( jqxhr ) {
		...
		{
			case 21:
				ShowAlertDialog( 'Virhe', 'Sinun tulee olla sisäänkirjautuneena toiminnon suorittamiseksi.' );
				break;
			case 24:
				...
				break;
			case 15:
				ShowAlertDialog( 'Virhe', 'Sinulla ei ole oikeuksia toiminnon suorittamiseen.' );
				break;
			default:
				ShowAlertDialog( 'Virhe', 'Pyynnön käsittelyssä ilmeni virhe: ' + responseJSON.success );
				break;
		}
	} );
	return false;
