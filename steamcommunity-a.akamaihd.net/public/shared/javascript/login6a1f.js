...
CLoginPromptManager.prototype.DoLogin = function()
{
	...
	$J.post( this.m_strBaseURL + 'getrsakey/', this.GetParameters( { username: username } ) )
		...
		.fail( function () {
			ShowAlertDialog( 'Erreur', 'Un problème de communication avec les serveurs Steam a été rencontré. Veuillez réessayer plus tard.' );
